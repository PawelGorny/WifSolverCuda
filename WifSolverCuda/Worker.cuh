...
__device__ __noinline__ bool _checksumDoubleSha256CheckUncompressed(unsigned int checksum, beu32* d_hash, uint64_t* _start);

__device__ __noinline__ bool _checksumDoubleSha256(unsigned int checksum, beu32* d_hash);
